...
| 2.4 | **Pre-rebrand names.** ✅ **Resolved 2026-07-14:** in-code strings (R1), GitHub repo → `MusaCodes17/anton` (R2), and local folder → `anton` (R3) all renamed; git remote repointed; docs/paths swept. **Only surviving retained name:** the `shoe_deals.db` filename — kept deliberately (Litestream replica path keys off it; E6). | — | Resolved (E6 superseded) | MAINTENANCE_PLAN §4; changelog 2026-07-14. |
